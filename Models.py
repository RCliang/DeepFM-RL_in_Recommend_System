...
class Deepnet(nn.Module):
    def __init__(self, feature_columns, all_dim=40, gamma=0.5, w=0.5):
        ...
        self.self_attention = SelfAttention_Layer(
            dim=self.item_fea_col['feat_num'])
        self.FM = FMLayer()
    ...
    def forward(self, inputs):
        user_inputs, seq_inputs, feat_inputs = inputs
        ...
        deep_feat = self.dnn(feat_inputs)
        wide_feat = self.FMLayer(feat_inputs)
